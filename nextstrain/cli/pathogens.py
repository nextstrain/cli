...
from .url import URL
from .util import parse_version_lax, request_list
...
class PathogenVersion:
    ...
    def update(self) -> UpdateStatus:
        ...
        # XXX TODO: Run setup checks here?  They're not part of the setup()
        # call above, but we could invoke them separately.  None of the
        # update() routines for runtimes run their checks, but that feels like
        # an oversight?
        #   -trs, 3 Feb 2025
