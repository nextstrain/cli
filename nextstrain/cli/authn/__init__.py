...
def _config_section(origin: Origin) -> str:
    ...
    # XXX TODO: Consider removing this special-casing of nextstrain.org—that
    # is, stop using [authn] and have it use [authn https://nextstrain.org]
    # like other remotes—by detecting the old section and automatically
    # migrating it from the former to the latter.  Or maybe don't worry about
    # it!
    #   -trs, 20 Nov 2023
